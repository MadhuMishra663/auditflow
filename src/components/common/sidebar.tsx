...
//   { id: "risk-management",  label: "Risk Management",   icon: "alert" },
//   { id: "compliance",        label: "Compliance",         icon: "clipboard" },
//   { id: "policies",          label: "Policies",           icon: "file" },
//   { id: "audit-management",  label: "Audit Management",  icon: "search" },
...
//   const color = active ? "#6B4EFF" : "#9CA3AF";
//   if (name === "grid") return (
//     <svg viewBox="0 0 24 24" fill="none" width="18" height="18" stroke={color} strokeWidth={1.8}>
...
//   onMobileClose = () => {},
// }: {
//   orgName?: string; orgTag?: string; userName?: string; userRole?: string;
//   userRoleType?: string; mobileOpen?: boolean; onMobileClose?: () => void;
// }) {
//   const router = useRouter();
//   const pathname = usePathname();
//   const activeItem = getActiveItem(pathname);
//   const allowed = ROLE_PERMISSIONS[userRoleType] ?? ROLE_PERMISSIONS.ADMIN;
//   const filteredItems = NAV_ITEMS.filter((item) => allowed.includes(item.id));
...
//   return (
//     <>
//       <link href="https://fonts.googleapis.com/css2?family=Inknut+Antiqua:wght@400&display=swap" rel="stylesheet" />

//       {/* Desktop Sidebar */}
//       <aside className="hidden md:flex fixed left-0 top-0 w-[358px] h-screen overflow-hidden bg-white border-r border-[#E8F1F8] flex-col px-2 py-4 z-40">
//         {/* Logo */}
//         <div className="flex items-center gap-3 w-full h-[62px] px-2 mb-2">
//           <div className="w-10 h-10 rounded-[10px] bg-gradient-to-br from-[#6B9AC4] to-[#5B21B6] flex items-center justify-center flex-shrink-0 shadow-[0_2px_8px_rgba(91,33,182,0.30)]">
//             <ShieldIcon className="w-5 h-5 text-white" />
//           </div>
//           <span className="text-[20px] text-gray-900 leading-tight tracking-tight" style={{ fontFamily: "'Inknut Antiqua', serif", fontWeight: 400 }}>AuditFlow</span>
//         </div>

//         {/* Organisation card */}
//         <div className="bg-[#F7F6FA] rounded-lg px-3 py-[10px] mb-2">
//           <div className="flex items-center gap-1.5 mb-1.5">
//             <BuildingIcon />
//             <span className="text-[10px] font-medium text-gray-500 uppercase tracking-[0.07em]">Current Organization</span>
//           </div>
//           <p className="text-[15px] font-bold text-gray-800 mb-1.5">{orgName}</p>
//           <span className="inline-block text-[11px] font-semibold text-violet-700 bg-[#E8F1F8] px-2.5 py-0.5 rounded-full">{orgTag}</span>
//         </div>

//         {/* Role card */}
//         <div className="bg-[#F7F6FA] rounded-lg px-3 py-[10px] mb-4">
//           <div className="flex items-center gap-1.5 mb-1.5">
//             <ShieldIcon className="w-3 h-3 text-gray-400" />
//             <span className="text-[10px] font-medium text-gray-500 uppercase tracking-[0.07em]">Your Role</span>
//           </div>
//           <p className="text-[15px] font-bold text-gray-800 mb-0.5">{userRole}</p>
//           <p className="text-xs text-gray-500">{userName}</p>
//         </div>
...
//               <button
//                 key={item.id}
//                 onClick={() => handleNavigate(ROUTES[item.id])}
//                 className={`w-full h-[59px] rounded-lg bg-[#F7F6FA] flex items-center gap-3 pl-5 pr-4 cursor-pointer text-sm text-left transition-colors duration-150 ${
//                   isActive ? "font-semibold text-[#6B4EFF]" : "font-medium text-gray-600 hover:text-gray-800"
//                 }`}
//               >
...
//       {/* Mobile backdrop */}
//       {mobileOpen && <div className="md:hidden fixed inset-0 z-50 bg-black/40 backdrop-blur-sm" onClick={onMobileClose} />}

//       {/* Mobile drawer */}
//       <aside className={`md:hidden fixed top-0 left-0 h-screen w-[300px] bg-white border-r border-[#E8F1F8] flex flex-col px-2 py-4 z-[60] overflow-y-auto transform transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}>
//         <div className="flex justify-end mb-2 pr-1">
//           <button onClick={onMobileClose} className="p-2 rounded-md text-gray-500 hover:text-gray-800 hover:bg-gray-100 transition-colors" aria-label="Close menu">
//             <CloseIcon />
//           </button>
//         </div>
