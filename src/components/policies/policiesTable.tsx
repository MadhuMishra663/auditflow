    ...
    >
      ...
      <div className="flex items-center justify-end gap-3 mb-5">
        ...
        <div className="w-full sm:w-auto">
          <Button
            text="Add"
            onClick={() => console.log("Add Policies clicked")}
        ...
        <div className="relative">
          ...
          {showSortMenu && (
            <div
              className="absolute right-0 mt-1 bg-white rounded-xl shadow-lg z-20 w-44 py-1"
            ...
            >
              {[
                ...
                <button
                  ...
                  style={{
                    color: sortBy === val ? "#8B6FD4" : "#000000",
        ...
        <div className="relative">
          ...
          {showOptionMenu && (
            <div
              className="absolute right-0 mt-1 bg-white rounded-xl shadow-lg z-20 w-48 py-2"
              style={{ border: "1px solid #DCD7F8" }}
            >
              <p
              ...
              {["All", "Active", "Draft"].map((s) => (
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-sm hover:bg-gray-50 flex items-center justify-between"
                  style={{
                    color: statusFilter === s ? "#8B6FD4" : "#000000",
              ...
              {[
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-sm hover:bg-gray-50 flex items-center justify-between"
                  style={{
                    color: categoryFilter === c ? "#8B6FD4" : "#000000",
      ...
      >
        ...
        <div className="hidden sm:block">
          {paginated.length === 0 && (
            <div className="py-12 text-center" style={{ color: "#000000" }}>
              No policies found.
            </div>
          )}
          {paginated.map((p, idx) => (
            <div
              ...
              style={{
                gridTemplateColumns: "2.5fr 0.8fr 1fr 1fr 1fr 1.2fr 0.8fr",
                borderBottom:
                  idx !== paginated.length - 1 ? "1px solid #DCD7F8" : "none",
              }}
            >
