...
const ShieldIcon = ({ className = "w-4 h-4", style }: { className?: string; style?: React.CSSProperties }) => (
  <svg viewBox="0 0 24 24" fill="none" className={className} style={style} stroke="currentColor" strokeWidth={1.8}>
...
const NAV_ITEMS = [
  ...
  { id: "settings",         label: "Settings",         icon: (c: string) => <SettingsIcon color={c} /> },
];
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "6px" }}>
            <BuildingIcon />
            <span style={{ fontSize: "10px", fontWeight: 500, color: "#6B7280", textTransform: "uppercase", letterSpacing: "0.07em" }}>
              Current Organization
            </span>
          </div>
          <p style={{ fontSize: "15px", fontWeight: 700, color: "#1F2937", margin: "0 0 6px 0", lineHeight: 1.3 }}>
            {orgName}
          </p>
          <span
            style={{
        ...
        >
          ...
          <p style={{ fontSize: "15px", fontWeight: 700, color: "#1F2937", margin: "0 0 3px 0", lineHeight: 1.3 }}>
            {userRole}
          </p>
